...
bool ModelDefinition_SerializeGetModelDefinitionCommandResponse(char* response, char* payloadBuffer, int size)
{
    if (payloadBuffer == NULL)
    {
        return false;
    ...
    if (neededSize > size - 1)
    {
        LogError("Failed to build getModelDefinition response payload string");
        return false;
    }
    else
    {
