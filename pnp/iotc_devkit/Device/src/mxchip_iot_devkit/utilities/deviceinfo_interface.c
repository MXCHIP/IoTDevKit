...
DIGITALTWIN_CLIENT_RESULT DeviceinfoInterface_Property_ReportManufacturer()
{
    ...
    {
        LogError("DEVICEINFO_INTERFACE: serialize readonly property manufacturer failed");
...
DIGITALTWIN_CLIENT_RESULT DeviceinfoInterface_Property_ReportModel()
{
    ...
    {
        LogError("DEVICEINFO_INTERFACE: serialize readonly property model failed");
        return DIGITALTWIN_CLIENT_ERROR;
    }
}
...
DIGITALTWIN_CLIENT_RESULT DeviceinfoInterface_Property_ReportSwVersion()
{
    ...
    {
        LogError("DEVICEINFO_INTERFACE: serialize readonly property swVersion failed");
        return DIGITALTWIN_CLIENT_ERROR;
    }
}
...
DIGITALTWIN_CLIENT_RESULT DeviceinfoInterface_Property_ReportOsName()
{
    ...
    {
        LogError("DEVICEINFO_INTERFACE: serialize readonly property osName failed");
        return DIGITALTWIN_CLIENT_ERROR;
    }
}
...
DIGITALTWIN_CLIENT_RESULT DeviceinfoInterface_Property_ReportProcessorArchitecture()
{
    ...
    {
        LogError("DEVICEINFO_INTERFACE: serialize readonly property processorArchitecture failed");
        return DIGITALTWIN_CLIENT_ERROR;
    }
}
...
DIGITALTWIN_CLIENT_RESULT DeviceinfoInterface_Property_ReportProcessorManufacturer()
{
    ...
    {
        LogError("DEVICEINFO_INTERFACE: serialize readonly property processorManufacturer failed");
        return DIGITALTWIN_CLIENT_ERROR;
    }
}
...
DIGITALTWIN_CLIENT_RESULT DeviceinfoInterface_Property_ReportTotalStorage()
{
    ...
    {
        LogError("DEVICEINFO_INTERFACE: serialize readonly property totalStorage failed");
        return DIGITALTWIN_CLIENT_ERROR;
    }
}
...
DIGITALTWIN_CLIENT_RESULT DeviceinfoInterface_Property_ReportTotalMemory()
{
    ...
    {
        LogError("DEVICEINFO_INTERFACE: serialize readonly property totalMemory failed");
        return DIGITALTWIN_CLIENT_ERROR;
    }
}
...
DIGITALTWIN_INTERFACE_CLIENT_HANDLE DeviceinfoInterface_Create()
{
    ...
    if ((result = DigitalTwin_InterfaceClient_Create(DeviceinfoInterfaceId,  DeviceinfoComponentName, DeviceinfoInterface_InterfaceRegisteredCallback, (void*)&appState, &interfaceHandle)) != DIGITALTWIN_CLIENT_OK)
    {
        LogError("DEVICEINFO_INTERFACE: Unable to allocate interface client handle for interfaceId=<%s>, componentName=<%s>, error=<%s>", DeviceinfoInterfaceId, DeviceinfoComponentName, MU_ENUM_TO_STRING(DIGITALTWIN_CLIENT_RESULT, result));
        interfaceHandle = NULL;
    }

    else
    {
        LogInfo("DEVICEINFO_INTERFACE: Created DIGITALTWIN_INTERFACE_CLIENT_HANDLE successfully for interfaceId=<%s>, componentName=<%s>, handle=<%p>", DeviceinfoInterfaceId, DeviceinfoComponentName, interfaceHandle);
